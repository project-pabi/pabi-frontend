...
import { NextButton, PrevButton, StyledTab, SubTitle, TabTitle, Title } from './Information.style';
      ...
      <TabContext value={value}>
        ...
        <TabPanel
          ...
          <div className="flex justify-center mt-[88px]">
            <div className="w-[280px] h-[380px] shadow-[0_4px_20px_4px_rgba(228,228,247,0.8)] mr-6">실시간 거래</div>
            <div className="w-[280px] h-[380px] shadow-[0_4px_20px_4px_rgba(228,228,247,0.8)]">일반 경매</div>
          </div>
        ...
        <TabPanel
          ...
          <TabTitle>
            경매를 <span style={{ color: '#0000D8' }}>시작할 가격</span>을 알려주세요
          </TabTitle>
          <div className="flex justify-center mt-10 s">
            <PrevButton
              onClick={() => {
